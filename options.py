...
class Options():
    ...
    def initialize(self):
        self.parser.add_argument('--train_dataset', type=str, default='./data/train_local',
                                 help='path to training dataset')
        self.parser.add_argument('--dev_dataset', type=str, default='./data/test_a_local',
                                 help='path to development dataset')
        self.parser.add_argument('--dev_dataset', type=str, default='./data/test_b_local',
        ...
        self.parser.add_argument('--load', type=int, default=0, help='whether to load the last model')
